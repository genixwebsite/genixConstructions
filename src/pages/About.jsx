        ...
        <div className="flex-1 flex items-center justify-center p-8 ml-12">
          <div>
            ...
            <p data-aos="zoom-in" className="text-lg text-justify">
              ...
              company. which has a team of skilled professionals, who has
              decades of experience in execution of High-End Residential
              Projects, Luxury Tented Resorts/ Boutique Hotels, Office Fit-Out
              Work & Industrial Projects. We offer a wide range of services of
              ...
              such as Civil Experience Engineers, Architect, MEP and HVAC
              Consultant. who work together to deliver high-quality projects
            ...
            <div className="flex flex-col md:flex-row mb-8">
              ...
              <div className="md:w-1/2 md:order-1 flex items-center justify-center p-4">
                <div data-aos="fade-right">
                  ...
                  <p className="text-lg mb-2">
                    Co -Founder & Director - B-Tech & MBA(Finance & Marketing)
                  </p>
                  <p className="text-lg text-justify">
