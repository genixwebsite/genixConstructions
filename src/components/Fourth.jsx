  ...
  return (
    <div className="flex flex-col md:flex-row h-auto min-h-screen">
      <div className="bg-white h-auto md:h-screen w-full md:w-2/5 flex justify-center items-center p-8 md:p-16">
        <div
          data-aos="fade-right"
          className="text-3xl md:text-6xl font-bold text-[#E30B21] text-center"
        >
          Our Services
        </div>
      </div>
      <div className="bg-[#E30B21] h-full w-full md:w-3/5 flex flex-wrap justify-center items-center p-4 md:p-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
          <div className='h-52 md:h-64 w-full bg-[url("/image6.jpg")] bg-cover bg-center relative group rounded-xl overflow-hidden'>
            <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center">
              <div className="text-lg md:text-2xl font-semibold text-white mt-12 md:mt-20 text-center group-hover:hidden">
                Residential & Commercial buildings
              </div>
              <div className="text-sm md:text-md text-white font-semibold mt-2 md:mt-4 text-center opacity-0 group-hover:opacity-100">
