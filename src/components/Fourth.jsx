        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
          <div className='h-52 md:h-64 w-full bg-[url("/image6.jpg")] bg-cover bg-center relative group rounded-xl overflow-hidden'>
            <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center">
              ...
              <div className="text-xs md:text-base text-white font-semibold mt-2 md:p-4 text-center opacity-0 group-hover:opacity-100 group-hover:delay-300 group-hover:group-focus:delay-300">
          ...
          <div className='h-52 md:h-64 w-full bg-[url("/image7.jpg")] bg-cover bg-center relative group rounded-xl overflow-hidden'>
            <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center rounded-lg">
              ...
              <div className="text-xs md:text-base text-white font-semibold mt-2 p-2 md:p-4 text-center opacity-0 group-hover:opacity-100 group-hover:delay-300 group-hover:group-focus:delay-300">
          ...
          <div className='h-52 md:h-64 w-full bg-[url("/image8.jpg")] bg-cover bg-center relative group rounded-xl overflow-hidden'>
            <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center">
              ...
              <div className="text-xs md:text-sm text-white font-semibold mt-2 md:p-2 text-center opacity-0 group-hover:opacity-100 group-hover:delay-300 group-hover:group-focus:delay-300">
          ...
          <div className='h-52 md:h-64 w-full bg-[url("/image9.jpg")] bg-cover bg-center relative group rounded-xl overflow-hidden'>
            <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center">
              ...
              <div className="text-xs md:text-base text-white font-semibold mt-2 md:mt-4 p-4 text-center opacity-0 group-hover:opacity-100 group-hover:delay-300 group-hover:group-focus:delay-300">
